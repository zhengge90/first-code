...
namespace WebSite.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ICategoryManager CategoryManager { get; set; }//这里是通过spring ioc注入吗，实际字段存的是CategoryManager类。
        ...
        public ActionResult Admin()
        {
            ...
            var list = this.CategoryManager.LoadAllEnable().Where(w => w.CategoryType == "列表");//这里调用的是CategoryManager类的LoadAllEnable（）方法
